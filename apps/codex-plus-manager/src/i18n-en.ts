...
export const EN_PLAIN: Record<string, string> = {
  ...
  "GPT Work 启动参数": "GPT Work launch arguments",
  "GPT Work 工具与插件": "GPT Work tools & plugins",
  "GPT Work 应用": "GPT Work app",
  "GPT Work 应用路径": "GPT Work app path",
  "GPT Work 意外停止": "GPT Work stopped unexpectedly",
  "GPT Work 版本": "GPT Work version",
  "GPT Work 目标": "GPT Work goals",
  "Codex++ 导入": "Codex++ import",
  "Codex++ 版本": "Codex++ version",
  "GPT Work增强": "GPT Work enhancements",
  "GPT Work增强模式": "GPT Work enhancement mode",
  "Debug 端口": "Debug port",
  "Fast 按钮": "Fast button",
  ...
  "控制语言、启动速度和 Codex 原生界面调整。": "Control language, startup speed and GPT Work native UI adjustments.",
  ...
  "与 Codex 内插件菜单使用同一个远端广告源": "Uses the same remote ad source as the in-GPT Work plugin menu",
  "个": "",
  "个会话": " session(s)",
  "中国官方": "China official",
  "主页": "Homepage",
  ...
  "从 Word 等富文本粘贴到 Codex composer 时只保留纯文本，避免被识别为图片/文件附件。需重启 Codex 才生效。":
    "Keeps only plain text when pasting rich text (e.g. from Word) into the GPT Work composer, avoiding it being treated as an image/file attachment. Requires restarting GPT Work.",
  ...
  "供应商配置总开关已关闭；当前只保存配置，不写入 Codex live 文件":
    "The provider configuration master switch is off; changes are only saved, not written to GPT Work live files",
  ...
  "关闭后本工具不会在手动切换时写入 Codex 的 config.toml / auth.json；启动 Codex 时始终不会自动改这些文件。":
    "When off, this tool won't write GPT Work's config.toml / auth.json on manual switches; it never auto-modifies these files when launching Codex.",
  ...
  "启动 GPT Work 时追加到默认 CDP 参数后。留空则保持默认启动行为。":
    "Appended after the default CDP arguments when launching the GPT Work app. Leave empty to keep default launch behavior.",
  ...
  "启动时通过本地主进程调试端口汉化 Codex 原生菜单；不修改安装包。需重启 Codex 才生效。":
    "Localizes the GPT Work native menu via the local main-process debug port at launch; doesn't modify the install package. Requires restarting GPT Work.",
  "启用": "Enable",
  "启用 Codex 图片覆盖层": "Enable GPT Work image overlay",
  "启用 Codex增强": "Enable GPT Work enhancements",
  ...
  "在 Codex 页面显示可拖动的后续建议浮层；建议由单独配置的 Stepwise API 生成。":
    "Shows a draggable follow-up suggestion overlay in the GPT Work page. Suggestions are generated by a separate Stepwise API.",
  ...
  "尚未刷新": "Not refreshed yet",
    "尚未检查 GPT Work 应用路径。": "GPT Work app path not checked yet.",
  ...
  "正在处理…": "Processing…",
  "工具与插件": "Tools & plugins",
  "已切回官方登录；Codex增强已设为兼容增强。": "Switched back to official login; GPT Work enhancements set to compatible.",
  "已切换到纯 API；Codex增强已设为完整增强。": "Switched to pure API; GPT Work enhancements set to full.",
  ...
  "已按此供应商切回官方登录；Codex增强已设为兼容增强。": "Switched back to official login for this provider; GPT Work enhancements set to compatible.",
  "已按此供应商切换到纯 API；Codex增强已设为完整增强。": "Switched to pure API for this provider; GPT Work enhancements set to full.",
  "已检测": "Detected",
  "已注册": "Registered",
  ...
  "强制启用 GPT Work 内置 zh-CN 语言包，避免 Statsig/VPN 不通时回退英文。需重启 Codex 才能完整生效。":
    "Forces the GPT Work app's built-in zh-CN language pack to avoid falling back to English when Statsig/VPN is unreachable. Requires restarting Codex to fully apply.",
  "当前": "Current",
  "当前 provider": "current provider",
  "当前不会写入 Codex config.toml / auth.json。打开供应商配置总开关后再切换。":
    "GPT Work config.toml / auth.json won't be written right now. Turn on the provider configuration master switch before switching.",
  "当前为": "Currently ",
  ...
  "未检查": "Not checked",
  "未检测到": "Not detected",
  "未检测到 GPT Work 应用版本。": "GPT Work app version not detected.",
  ...
  "本地 Codex 增强、管理工具和安装包维护": "Local GPT Work enhancements, management tools and install package maintenance",
  "本地会话": "Local sessions",
  "本地整体": "Local overall",
  "本地脚本": "Local scripts",
  "权重": "Weight",
  ...
  "查看、删除和修复 Codex 本地会话": "View, delete and repair GPT Work local sessions",
  "检查": "Check",
  "检查与修复": "Check & repair",
  ...
  "正在写入 Codex 配置…": "Writing GPT Work config…",
  ...
  "独立管理 Codex 的 MCP、Skills、Plugins；切换任意供应商都会带上。":
    "Manage GPT Work's MCP, Skills and Plugins independently; they carry over whenever you switch providers.",
  ...
  "管理 Codex SSH 项目并加入 Zed workspace": "Manage GPT Work SSH projects and add them to a Zed workspace",
  ...
  "读取 Codex 本地 SQLite 会话库，会删除数据库记录和对应 rollout 文件":
    "Reads GPT Work's local SQLite session database; deletes database records and the corresponding rollout files",
  ...
  "默认关闭；开启后启动 Codex 时会自动保留官方 Computer Use 插件所需的 config.toml、bundled 插件和 notify 配置。":
    "Off by default; when on, launching GPT Work automatically preserves the config.toml, bundled plugins and notify config required by the official Computer Use plugin.",
  "默认启动 Codex 时使用的模型名，请勿带后缀；上下文窗口请在下方「模型列表」中按模型单独配置。":
    "The model name used by default when launching GPT Work; don't include a suffix. Configure context windows per model in the “Model list” below.",
  "默认关闭；无 VPN 时可开启，让 Statsig 初始化快速失败，减少启动时长。需重启 Codex 才生效。":
    "Off by default; enable it without a VPN to let Statsig initialization fail fast and reduce launch time. Requires restarting GPT Work.",
  "默认打开策略": "Default open strategy",
  "（": " (",
  "）": ")",
  "，可以从通用配置文件或这里新增。": "; you can add them from the common config file or here.",
  "，留空表示使用 Codex 默认长度。": "; leave empty to use GPT Work's default length.",
...
export const EN_TEMPLATE: Record<string, string> = {
  ...
  "发现 {0} 个 Codex 供应商": "Found {0} GPT Work provider(s)",
...
export const EN_BACKEND: Record<string, string> = {
  ...
  "未检测到会覆盖 Codex 供应商配置的 OPENAI 环境变量。": "No OPENAI environment variables found that would override the GPT Work provider config.",
  "检测到可能覆盖 Codex 供应商配置的 OPENAI 环境变量。": "OPENAI environment variables detected that may override the GPT Work provider config.",
  "环境变量已按确认项删除；重新启动 Codex 后生效。": "Environment variables deleted as confirmed. Restart GPT Work for changes to take effect.",
...
export const EN_BACKEND_PATTERNS: Array<[RegExp, string]> = [
  ...
  [/^已读取 cc-switch Codex 供应商配置：(\d+) 个。$/, "Read $1 cc-switch GPT Work provider config(s)."],
  ...
  [/^创建 Codex 配置目录失败：(.+)$/, "Failed to create GPT Work config directory: $1"],
